...
public class SynchronizationException extends Exception {
    ...
    private final Map<String, Object> related;

    public SynchronizationException(StatusCode code, String msg) {
        this(code, Collections.emptyMap(), msg);
    }

    public SynchronizationException(StatusCode code, Map<String, Object> related, String msg) {
        super(msg);
        this.code = code;
    ...
    public SynchronizationException(StatusCode code, Map<String, Object> related, String msg, Throwable reason) {
        super(msg, reason);
        this.code = code;
        this.related = related;
    }
